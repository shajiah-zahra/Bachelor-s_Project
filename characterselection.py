...
class CharacterSelection:
 ...
 def __init__(self):
    ...
    red = loader.loadTexture("assets/gui/CharRedBG.jpg")
    ...
    blue = loader.loadTexture("assets/gui/CharBlueBG.jpg")
 ...
 def selectCharacter(self, charNr):
    if self.char1Frame["image"] == None:
        self.char1Frame["image"] = "assets/gui/Char{}_L.png".format(
        charNr)
        ...
        self.char2Frame["image"] = "assets/gui/Char{}_R.png".format(
        charNr)
